...
SECRET_KEY = 'django-insecure-h#0xs^n4pk4e&0i-md6ciui&e^m40==c*ws=&yqi8f7@jjqeuz'
...
# For session caching with Redis (optional)
SESSION_ENGINE = 'django.contrib.sessions.backends.cache'
SESSION_CACHE_ALIAS = 'default'

# Cache timeout settings
CACHE_TTL = 60 * 15  # Cache for 15 minutes (adjust as needed)
